        ...
        {step === 'form' && (
          <div className="space-y-4 rounded-2xl bg-white p-5 shadow-sm">
            <div className="rounded-lg bg-green-50 p-3">
              <p className="text-xs font-medium text-green-700">Fund a customer's wallet with cash received.</p>
            </div>

            {/* Customer Phone */}
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700">Customer Phone Number</label>
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 py-3 pl-12 pr-4 text-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-200"
                  />
                </div>
                <button onClick={handleLookup} disabled={loading} className="shrink-0 rounded-lg bg-green-600 px-4 text-sm font-medium text-white hover:bg-green-700 disabled:opacity-50">
                  {loading ? '...' : 'Find'}
                </button>
              </div>
              {recipient && (
